<template>
	<view class="cash">
		...
		<view style="padding: 16px;border-radius: 8px">
			...
			<text class="num" style="font-size: 18px;color: #FF6DB2;margin-bottom: 10px">{{totalMoney}} 元</text>
		...
		<view style="text-align: center;margin-top: 32px;width: 100%;padding-bottom: 32px">
			<view @click="getOut" v-if="money!=='0'" style="margin-left: 40px;margin-right:40px;font-size: 18px;background: #FF6DB2;color: white;border-radius: 10px;height: 40px;line-height: 40px">
				提现
			</view>
