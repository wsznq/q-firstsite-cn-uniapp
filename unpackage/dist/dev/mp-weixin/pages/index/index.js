...
/***/ 23:
/*!********************************************************************************************!*\
  !*** D:/My Software/UniApp/q-firstsite-cn-uniapp/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \********************************************************************************************/
...
/***/ 24:
/*!*************************************************************************!*\
  !*** D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ 25:
/*!********************************************************************************************************!*\
  !*** D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \********************************************************************************************************/
...
/***/ 26:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 27:
/*!**************************************************************************************************!*\
  !*** D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 28:
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  onLoad: function onLoad() {
    ...
    var gender = this.$queue.getData(this.genderKey);
    if (gender) {
      if (gender === 1) {
        this.gender = gender;
      }
  ...
  methods: {
    ...
    loadBanner: function loadBanner(Refresh) {var _this = this;
      ...
      if (indexBanner && Refresh == undefined) {
        ...
        this.$Request.post(this.$Api.home.banners).then(function (res) {
          if (res.Code === 1) {
            var bannerList = res.Message;
            bannerList.forEach(function (item) {
              item.DocumentPictureUrl = _this.$Url + item.DocumentPictureUrl;
            });
            _this.banners = bannerList;
            _this.$SysCache.put("app_index_banner", res.Message, 43200);
          }
        });
      }
    },
    loadJuhuasuanlist: function loadJuhuasuanlist() {var _this2 = this;
      var materialId = "3756";
      ...
      then(function (res) {
        if (res.Code === 1) {
          _this2.juhuasuanlist = [];
          res.Message.forEach(function (d) {
            _this2.juhuasuanlist.push(d);
          });
        }
    ...
    /**
        * @param {Object} type加载
        */
    loadCouponList: function loadCouponList(type) {var _this3 = this;
      var materialId;
      var cid = this.category[this.TabCur].positon;
      var apiUrl = this.$Api.common.couponlist;
      if (cid === 0) {
      ...
      this.$Request.get(apiUrl, {
        ...
        DeviceValue: this.deviceValue }).
      then(function (res) {
        _this3.category[_this3.TabCur].loadingType = 0;
        if (res.Code === 1) {
          if (_this3.page === 1) {
            _this3.category[_this3.TabCur].orderList = [];
          }
          res.Message.forEach(function (d) {
            ...
            _this3.category[_this3.TabCur].orderList.push(d);

          });
        } else {
          _this3.category[_this3.TabCur].loadingType = 2;
        }
        if (type === 'Refresh') {
          uni.stopPullDownRefresh(); // 停止刷新
        }
    ...
    /**
        * 加载公告
        */
    loadMessage: function loadMessage() {var _this4 = this;
      this.$Request.getT(this.$Api.home.messagelist).then(function (res) {
        if (res.Code === 1) {
          _this4.messageList = res.Message;
        }
      });
    },
    ...
    changeTab: function changeTab(e) {
      ...
      var list = this.category[e.target.current].orderList;
      if (list.length == 0) {
        uni.showLoading({
          title: '加载中...' });
    ...
    toCategory: function toCategory(son_name) {
      uni.navigateTo({
    ...
    TklmaskCloses: function TklmaskCloses(e) {
      this.$refs.simpleModalTkls.hide();
    },
    //获取剪切板
    getClipboardData: function getClipboardData() {var _this5 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var that;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                that = _this5;
                uni.getClipboardData({
                  ...
                  fail: function fail(res) {} });case 2:case "end":return _context.stop();}}}, _callee);}))();

    },
    /**
        * 会员授权界面
        */
    goPublisherInfo: function goPublisherInfo() {
    ...
    /**
        ...
        */
    choseGender: function choseGender(type) {
    ...
    toNavList: function toNavList(url, title) {
      ...
      if (url === "meirishangxin") {
        uni.navigateTo({
          url: '/pages/index/tuiguang?cid=0' });

      } else
      if (url === "jinxuanmeizhuan") {
        uni.navigateTo({
      ...
      if (url === "jinxuannvzhuang") {
        uni.navigateTo({
          url: '/pages/index/tuiguang?cid=1' //女装精选
        });
      } else
      if (url === "gengduofenlie") {
    ...
    toGoodsInfo: function toGoodsInfo(url) {
    ...
    toGoodsInfos: function toGoodsInfos(e) {
      var relation_id = this.$queue.getData('relation_id');
...
/***/ 32:
/*!***********************************************************************************************************!*\
  !*** D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 33:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/My Software/UniApp/q-firstsite-cn-uniapp/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
