<template>
	<view>
		<view @click="open(item)" class="itemInfo1" v-bind:key='itemid'>
			...
			<view>
				...
				<view>
					...
					<view style="margin-top: 2px;display: flex">
						<view style="display: flex;width: 40%;margin-left: 12upx;">
						...
						<view style="width: 60%;font-size: 22upx;text-align:center;margin-top: 8upx;color: grey; text-overflow: ellipsis;overflow: hidden">{{ itemsale }}</view>
					</view>
					...
					<view style="display: flex;margin-left: 12upx;">
						...
						<view style="width: 60%;text-align: center;margin-bottom: 8upx;margin-left: 16upx">
							<view class="quan" style="width: 80%;font-size: 24upx;text-align: center; height: 44upx;padding-top:4upx;color: white;padding-left: 16upx;padding-right: 16upx">
								{{ couponmoney }}元券
							</view>
						</view>
						<!--  #endif -->
						<!--  #ifndef APP-PLUS -->
						<view style="width: 60%;text-align: center;margin-bottom: 8upx;margin-left: 16upx">
							<view class="quan" style="width: 80%;font-size: 28upx;text-align: center;height: 44upx;color: white;padding-left: 16upx;padding-right: 16upx">
								{{ couponmoney }}元券
							</view>
						</view>
						<!--  #endif -->
